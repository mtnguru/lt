      ...
      <div className="control-flex">
        <div className="controls">
          <div className="control-bar arduino2">
            ...
            <ControlButton client="arduino2" metricId="arduino2_LED_Onboard_On" type="toggle" label="Onboard Light" className="onboard" clickH={clickH}></ControlButton>
          </div>
          <div className="control-bar arduino3">
            ...
            <ControlButton client="arduino3" metricId="arduino3_LED_Onboard_On" type="toggle" label="Onboard Light" className="onboard" clickH={clickH}></ControlButton>
          </div>
          <div className="control-bar arduino4">
            ...
            <ControlButton client="arduino4" metricId="arduino4_LED_Onboard_On" type="toggle" label="Onboard Light" className="onboard" clickH={clickH}></ControlButton>
          </div>
          <div className="control-bar arduino5">
            ...
            <ControlButton client="arduino5" metricId="arduino5_LED_Onboard_On" type="toggle" label="Onboard Light" clickH={clickH}></ControlButton>
          </div>
        ...
        <div className="stats">
          <ControlStats metricId="arduino2_K_Outdoors_C" type="status" label="Outdoors" cname=""></ControlStats>
          <ControlStats metricId="Cabin_K_Outside_C" type="status" label="Rio Outside" cname=""></ControlStats>
        </div>
        <div className="stats">
          <ControlStats metricId="arduino3_K_LivingRoom_C" type="status" label="Living Room" cname=""></ControlStats>
          <ControlStats metricId="arduino4_K_KitchenCeiling_C" type="status" label="Kitchen Ceiling" cname=""></ControlStats>
        </div>
        <div className="stats">
          <ControlStats metricId="Cabin_K_Bedroom_C" type="status" label="Rio Bedroom" cname=""></ControlStats>
          <ControlStats metricId="Cabin_K_Fireplace_C" type="status" label="Rio Fireplace" cname=""></ControlStats>
        </div>
      </div>
    </div>
  )
