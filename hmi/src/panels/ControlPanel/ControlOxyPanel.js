    ...
    <Box className="panel control-oxy-panel mqtt-clientId-bg">
      ...
      <Box className="controls" >
        <Box className="control-bar gas-flow"       mb={10}>
          <ControlMetric metricId="Ez_NA_SmartTrack_slpm" label="HHO Flow" cname=""></ControlMetric>
          <ControlSlider metricId="Ez_NA_SmartTrack_slpm" onChange={onChange} />
        </Box>
        <Box className="control-bar voltage"        mb={10}>
          <ControlMetric metricId="PS_NA_Human_V" label="PS Volts" cname=""></ControlMetric>
          <ControlSlider metricId="PS_NA_Human_V" onChange={onChange} />
        </Box>
        <Box className="control-bar amps"           mb={10}>
          <ControlMetric metricId="PS_NA_Human_A" label="PS Amps" cname=""></ControlMetric>
          <ControlSlider metricId="PS_NA_Human_A" onChange={onChange} />
        </Box>
        <Box className="control-bar ez-temperature" mb={10}>
          <ControlMetric metricId="Ez_NA_Mtr_C" label="Ez Temp" cname=""></ControlMetric>
          <ControlSlider metricId="Ez_NA_Mtr_C" onChange={onChange} />
        </Box>
      </Box>
    </Box>
  )
